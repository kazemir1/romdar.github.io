...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const processData = {
        1: {
            ...
            text: "Определение места должности в цепочке создания ценности \nАнализ бизнес-процессов, в которых участвует сотрудник \nФормулировка ключевых задач и зон влияния \nВыявление процессных барьеров"
        },
        2: {
            title: "ОПИСАНИЕ СОТРУДНИКА",
            icon: '<i class="fas fa-user-tie"></i>',
            text: "Знания\n Навыки необходимые для выполнения задач (Hard skills) \nЛичные качества - характеристики, влияющие на эффективность (Soft skills) \nМотивация (факторы стимулирующие сотрудника эффективно работать)"
        },
        3: {
            title: "РАЗРАБОТКА МЕТОДОВ ОТБОРА",
            icon: '<i class="fas fa-filter"></i>',
            text: "Выбор оптимальных методов оценки (собеседования, тесты, кейсы, ассессмент, глубинное интервью…)\nРазработка инструментов и оценки под профиль кандидата\nОписание индикаторов и разработка шкал оценки\nСоздание бланка оценки\nМатрица оценки кандидатов"
        },
        4: {
            title: "ПЕРЕДАЧА ИНСТРУМЕНТОВ ОТБОРА",
            icon: '<i class="fas fa-tools"></i>',
            text: "Обучение HR – специалистов партнера методам отбора\nСопровождение процедуры отбора на начальной стадии\nПоддержка процесса"
        },
        5: {
            title: "СИСТЕМА АДАПТАЦИИ",
            icon: '<i class="fas fa-user-plus"></i>',
            text: "Разработка индивидуального плана адаптации (на 1-3 месяца)\nРазработка и внедрение процедуры наставничества (положение о наставничестве, обучение наставников*)\nРазработка программы вводного обучения\nИнструменты контроля эффективности системы адаптации (метрики, собеседование на выходе, настройка системы учета причин ухода)"
        },
        6: {
            title: "СИСТЕМА ОБУЧЕНИЯ И РАЗВИТИЯ",
            icon: '<i class="fas fa-graduation-cap"></i>',
            text: "Меню развивающих мероприятий\nТренинги (онлайн/офлайн)\nE-learning\nСтратегические сессии\nКоучинг\nМенторинг\nФормат «Люди учат людей»\nПрограммы подготовки кадрового резерва"
        },
        7: {
            title: "СИСТЕМА МОТИВАЦИИ НА ОСНОВЕ KPI",
            icon: '<i class="fas fa-chart-line"></i>',
            text: "Рекомендации по выбору оптимальной системы вознаграждения (оклад, бонусы, премии)\nОпределение ключевых показателей эффективности и привязка мотивации к ним\nРекомендации по внедрению системы нематериальной мотивации"
        },
        8: {
            title: "ЦЕЛЕПОЛАГАНИЕ И УПРАВЛЕНИЕ РЕЗУЛЬТАТИВНОСТЬЮ",
            icon: '<i class="fas fa-bullseye"></i>',
            text: "Включает в себя:\nПроцедуру постановки годовых целей\nИндивидуальный план развития сотрудника\nСистему вознаграждений по итогам достижения годовых целей\nРегулярная оценка эффективности (2 раза в год)"
        }
    };
